...
import { Mail, Lock, User, Github, Chrome, ArrowRight, Loader2, CheckCircle2 } from 'lucide-react';
...
export const SignUp: React.FC = () => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // For this demo, we can suggest they sign in or wait
      ...
      <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-[#F9FAFB] p-4">
        ...
        >
          ...
          <p className="text-gray-500 mb-8 text-sm leading-relaxed">
            Chào mừng {fullName}! Tài khoản của bạn đã được khởi tạo. 
            <br /><br />
            <span className="inline-block p-3 bg-amber-50 rounded-xl border border-amber-100 text-amber-700">
              <strong className="block mb-1">💡 Mẹo nhỏ:</strong> 
              Nếu bạn không nhận được email, hãy vào <strong>Supabase Dashboard -> Authentication -> Providers -> Email</strong> và TẮT mục <strong>"Confirm email"</strong> để có thể đăng nhập ngay lập tức.
            </span>
          </p>
